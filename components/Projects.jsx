  ...
  return (
    <div className='w-full lg:w-[40%] xl:w-[30%] px-8 lg:px-0 transition-all'>
      ...
      <div className='relative w-full h-full'>
        <div className='hidden lg:block absolute top-0 left-0 rounded-tl-xl w-1/2 h-1/2 aspect-square bg-gradient-to-br p-[6px] from-[#6EE7B7] via-[#3B82F6] to-[#3B82F6]'></div>
